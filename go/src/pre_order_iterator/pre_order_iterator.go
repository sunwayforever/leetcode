...
func (this *PreOrderIterator) HasNext() bool {
	return this.hasNext
}

func (this *PreOrderIterator) Next() int {
	ret := this.next
	this.next, this.hasNext = this.getNext()
	return ret
}

func (this *PreOrderIterator) getNext() (int, bool) {
